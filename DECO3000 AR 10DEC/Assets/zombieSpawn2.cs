...
public class zombieSpawn2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        zombieCount = GameObject.FindGameObjectsWithTag("zombieBro2");
    ...
    void Update()
    {
        ...
        if (count == 500)
        {
            ...
            {
                PhotonNetwork.Instantiate("ZombieBro2_prefab", spawnPosition, transform.rotation, 0);
            }
